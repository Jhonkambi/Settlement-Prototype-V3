...
// Complete version with Void functionality
...
function loadQuizzesFromStorage() {
    try {
        ...
        // Ensure all quizzes have IDs (backward compatibility)
        allQuizzes = allQuizzes.map(quiz => ({
            id: quiz.id || generateQuizId(),  // Add missing IDs
            ...quiz,
...
function displayQuestions() {
    ...
    currentQuiz.questions.forEach((question, qIndex) => {
        ...
        const answerInputs = answerCell.querySelectorAll('input[type="radio"], textarea');
